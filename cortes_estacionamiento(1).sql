...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2018 a las 19:20:54
...
(222222, 5, 455, 451),
(323232, 78749849, NULL, NULL),
(747474, 96431055, NULL, NULL),
...
(323232, 323232, NULL, NULL),
(747474, 747474, NULL, NULL),
...
(323232, 2332323, NULL, NULL),
(747474, 7474747, NULL, NULL),
...
(8090, 12, '2018-08-22', 8090, 8090, 8090, 8090, 8090, 8090, 212, 'Si se pudo', 6, NULL, NULL),
...
(323232, 1, '2018-10-20', 323232, 323232, 323232, 323232, 323232, 323232, 2456, NULL, NULL, '04:58:00', '07:08:00'),
(747474, 1, '2018-10-20', 747474, 747474, 747474, 747474, 747474, 747474, 3330, NULL, NULL, '05:55:00', '05:07:00'),
...
--
ALTER TABLE `boletos_tipos`
  MODIFY `idboletos_tipos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
-- AUTO_INCREMENT de la tabla `coches_dentro`
--
ALTER TABLE `coches_dentro`
  MODIFY `idcoches_dentro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
-- AUTO_INCREMENT de la tabla `contador_est`
--
ALTER TABLE `contador_est`
  MODIFY `idcontador_est` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
...
--
ALTER TABLE `folios_rojos`
  MODIFY `idfolios_rojos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
-- AUTO_INCREMENT de la tabla `folio_emisor`
--
ALTER TABLE `folio_emisor`
  MODIFY `idfolio_emisor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
-- AUTO_INCREMENT de la tabla `reportes_cortes`
--
ALTER TABLE `reportes_cortes`
  MODIFY `idreportes_cortes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
...
--
ALTER TABLE `tarjetas_control`
  MODIFY `idtarjetas_control` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=898990;
--
